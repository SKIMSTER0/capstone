...
class Profile extends CI_Controller {
    ...
    public function __construct()
    {
        ...
        $this->TPL['leaderboardRank'] = $this->profile->getLeaderboardRank($_SESSION['userId']) ?? "No Games Played";
        $this->TPL['pcoCount'] = $this->profile->getBestPCOCount($_SESSION['userId']) ?? "No Games Played";
        $this->TPL['score'] = $this->profile->getBestScore($_SESSION['userId']) ?? "No Games Played";
    }
